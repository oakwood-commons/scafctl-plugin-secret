# scafctl-plugin-secret - AI Agent Instructions

## Overview

scafctl provider plugin implementing the **secret** provider.

## Key Patterns

- **Plugin SDK**: Uses `github.com/oakwood-commons/scafctl-plugin-sdk`
- **Entry point**: `cmd/scafctl-plugin-secret/main.go` calls `sdkplugin.Serve()`
